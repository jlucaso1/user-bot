...
* if you tool this tool to perform illegal things such as spam, or stalking, I will not take responsibility for such

**how to use**

* it's built in go lang, if you don't know what go/go-lang programming is, read it's [docs](https://go.dev/).
* they are some cli packages that are needed for important utility functions, such as creation of stickers, and various media commands that process images/videos
* ensure ffmpeg, cwebp and webpmux libraries are installed on your system to get the full experience
* if you are not running docker, i'll assume you are running this software for development purposes on your local machine. you will need to install ffmpeg, cwebp, and webpmux.
